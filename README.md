...
Although this is not an open-sourced project, the repo uses some aspects of open sourced development to keep well documented for future maintainers. All changes should be made through a PR linked to an issue and merged into the main branch. Changes to the main branch **will not** re-deploy the website. Once changes are ready to be deployed, the main branch should be merged into the prod branch using a separate PR. This should allow future maintainers to see the commit history in terms of general feature additions, instead of smaller commits out of context. 